...
$id	    = $_GET['id'];
$data   = mysqli_query($conn,"SELECT * FROM pemasukan WHERE id_pemasukan='$id'");
	...
	<div class="content">
		<div class="page-inner">
        	<div class="page-header">
				<h4 class="page-title">Ubah Data Pemasukan</h4>
				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-body py-3">
						    <form method="POST" action="./edit/pemasukan.php" autocomplete="off">
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        <label class="mt-3" for="tgl">Tanggal Pemasukan <span class="text-danger">*</span></label>
                                        <input type="date" class="form-control" name="tgl" id="tgl" value="<?= $d['tanggal_pemasukan']; ?>" required>
                                      	<input type="hidden" name="id" value="<?= $id; ?>" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="mt-3" for="rincian">Rincian Pemasukan <span class="text-danger">*</span></label>
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control" name="rincian" id="rincian" value="<?= $d['rincian_pemasukan']; ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="mt-3" for="nominal">Nominal Pemasukan <span class="text-danger">*</span></label>
                                        <div class="input-group mb-3">
                                            <input type="number" class="form-control" name="nominal" id="nominal" value="<?= $d['nominal_pemasukan']; ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-12">
