	...
	<div class="content">
		<div class="page-inner">
        	<div class="page-header">
				<h4 class="page-title">Tambah Akun Admin</h4>
				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-body py-3">
						    <form method="POST" action="./add/admin.php" autocomplete="off">
                                <div class="row mt-3">
                                    <div class="col-md-6">
...
<script>
    $("#submit").click(function(){
        ...
        var kota = $("#kota").val();
        var pass = $("#pass").val();
        if(nama==''||username==''||email==''||no_hp==''||norek==''||jk==''||alamat==''||no_rumah==''||kota==''||pass=''){
            Swal.fire({
