        ...
        if($pass == $kpass){
            ...
            if(isset($_POST['submit'])){
                ...
                && !empty($_POST['jenis_kelamin']) && !empty($_POST['alamat'])){
                    ...
                    id_jenis_kelamin = '$jenis_kelamin', tanggal_lahir = '$tgl_lahir', nama_jalan = '$alamat', no_jalan = '$no_rumah', id_kota='$kota',password='$hash' WHERE username = '$username'");
            ...
            header('Location:../index.php?alert=passnomatch');
        }
    }else{
        $username = $_SESSION['username'];
        if(isset($_POST['submit'])){
